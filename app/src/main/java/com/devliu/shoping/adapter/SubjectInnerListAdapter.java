...
import com.devliu.shoping.entities.home.GoodsListBean;
...
public class SubjectInnerListAdapter
        extends RecyclerView.Adapter<SubjectInnerListAdapter.SellerInnerListHolder>{
    private Context context;
    private List<GoodsListBean> innerList;

    public SubjectInnerListAdapter(Context context, List<GoodsListBean> innerList) {
    ...
    public void onBindViewHolder(SellerInnerListHolder holder, int position) {
        GoodsListBean innerGood = innerList.get(position);
